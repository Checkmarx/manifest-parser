...
func TestPypiParser_Parse_UvExportFile(t *testing.T) {
	filePath := "../../../test/resources/requirements-uv-export.txt"
	parser := &PypiParser{}
	pkgs, err := parser.Parse(filePath)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestPypiParser_Parse_PipFreezeFile(t *testing.T) {
	filePath := "../../../test/resources/requirements-pip-freeze.txt"
	parser := &PypiParser{}
	pkgs, err := parser.Parse(filePath)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestPypiParser_Parse_PipCompileFile(t *testing.T) {
	filePath := "../../../test/resources/requirements-pip-compile.txt"
	parser := &PypiParser{}
	pkgs, err := parser.Parse(filePath)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
