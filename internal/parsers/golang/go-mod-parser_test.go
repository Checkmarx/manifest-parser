	...
	expectedPackages := []models.Package{
		{
			...
			Locations:      []models.Location{{Line: 6, StartIndex: 8, EndIndex: 55}},
		},
		{
			PackageManager: "go",
			...
			FilePath:       manifestFile,
			Locations:      []models.Location{{Line: 7, StartIndex: 8, EndIndex: 78}},
		},
		{
			PackageManager: "go",
			...
			FilePath:       manifestFile,
			Locations:      []models.Location{{Line: 8, StartIndex: 8, EndIndex: 40}},
		},
		{
			PackageManager: "go",
			...
			Version:        "v1.0.1",
			FilePath:       manifestFile,
			Locations:      []models.Location{{Line: 12, StartIndex: 8, EndIndex: 42}},
		},
		{
			PackageManager: "go",
			...
			FilePath:       manifestFile,
			Locations:      []models.Location{{Line: 13, StartIndex: 8, EndIndex: 74}},
		},
		{
			PackageManager: "go",
			...
			Version:        "v1.4.0",
			FilePath:       manifestFile,
			Locations:      []models.Location{{Line: 14, StartIndex: 8, EndIndex: 43}},
		},
	}
